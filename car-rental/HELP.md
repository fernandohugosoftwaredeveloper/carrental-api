...
* The original package name 'com.bee.car-rental.api' is invalid and this project uses 'com.bee.carrental.api' instead.
...
* [Spring HATEOAS](https://docs.spring.io/spring-boot/docs/2.7.10-SNAPSHOT/reference/htmlsingle/#web.spring-hateoas)
